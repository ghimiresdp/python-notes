...
1. Try to replicate the line 17 and change  'hello world' to <your name> and print in the terminal
...
# print(Hello World)        # Gives error when the code is uncommented
